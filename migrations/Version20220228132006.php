 ...
 */
final class Version20220228132006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD nom_image VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP nom_image, CHANGE nom nom VARCHAR(200) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE desc_court desc_court VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE desc_long desc_long VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
